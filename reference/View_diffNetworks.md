...
Explore differential networks and interactively select regression and
box plots
...
- legend.arrow.width:
  ...
  width of the arrow used in the network legend. Default is 0.35. As the
  number of assayData matrices increases this parameter must be
  accordingly increased to avoid graphical errors in the legend.

- stepY_legend:

  vertical space between legend arrows. It is used together with
  `legend.arrow.width` to adjust the legend space in case of graphical
